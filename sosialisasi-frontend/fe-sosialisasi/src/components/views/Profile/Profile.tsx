                ...
                <div className="flex flex-row items-center gap-5">
                  <div className="flex flex-row items-center gap-2 rounded-xl border-2 border-[#5568FE] px-4 py-2">
                    <Image
                      ...
                      alt="Gambar"
                    />
                    <p className="font-medium text-[#5568FE]">Linked In</p>
                  </div>
                  <div
            ...
            <article className="flex flex-col">
              ...
              <div className="mt-4">
                <p className="text-sm whitespace-pre-wrap text-[#202020] sm:text-base">
                  Ini adalah contoh teks konten postingan. Bisa berisi deskripsi
                  atau tulisan panjang pengguna.
                </p>
              </div>
            ...
            <article className="flex flex-col">
              ...
              <div className="mt-4">
                <p className="text-sm whitespace-pre-wrap text-[#202020] sm:text-base">
                  ...
                  blanditiis temporibus laborum fugit tenetur officia sunt hic
                  nobis neque eum, corporis accusamus culpa sit nisi odio! Aut
                  hic minus cupiditate.
                </p>
              </div>
