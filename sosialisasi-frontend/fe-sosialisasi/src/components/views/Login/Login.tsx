...
const Login = () => {
  ...
  return (
    <div className="grid h-screen w-full grid-cols-5 overflow-hidden">
      <div className="col-span-2 flex h-full flex-col items-start justify-center gap-5 bg-[#122C49] px-[6.25rem]">
        <h1
          className={`${PrimaryFont} text-left text-2xl font-bold text-white`}
        >
          Welcome Back!
        </h1>
        <p className={`${PrimaryFont} text-base text-white`}>
        ...
        <p
          className={`${PrimaryFont.variable} w-full text-center text-base text-white`}
        >
          Not a member?{" "}
          <Link href="/auth/register" className="text-[#CEAE78]">
            Register now
          </Link>
        </p>
      </div>
